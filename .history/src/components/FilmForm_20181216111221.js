...
class FilmForm extends Component {
    ...
    validate = (data) => {
        ...
        if(!data.description) errors.title = "This field cann`t be blank";
        if(!data.duration <= 0) errors.title = "Too soer, isn`t it?";
        if(!data.price <= 0) errors.title = "Too cheap< isn`t it?";
        if(!data.director) errors.title = "This field cann`t be blank";
        if(!data.im) errors.title = "This field cann`t be blank";
        return errors;
    }
